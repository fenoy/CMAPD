...
public:
	...
	Instance(){}
	Instance(vector<bool> map, vector<vector<int>> agents, int num_of_agents = 0, int num_of_rows = 0, int num_of_cols = 0, int num_of_obstacles = 0, int warehouse_width = 0);
